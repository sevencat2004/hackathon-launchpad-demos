...
Checked: 2026-06-04 Asia/Shanghai.
...
| Sui GrantFlow Agent | Built, upgraded, packet ready, not submitted | not approved, not paid | later upload video and provide public Sui address if submitting |
...
2. Sui is now the next feasible submission if user can upload the video and provide public wallet/account details.
