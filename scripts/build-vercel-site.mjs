  ...
  <body>
    <main class="shell">
      <section class="intro">
        ...
        <p class="lede">A public preview hub for Codex-led hackathon projects focused on agentic bounty triage, operations workflows, and reviewer-ready handoff packets.</p>
      </section>
